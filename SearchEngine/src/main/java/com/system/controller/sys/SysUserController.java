...
import com.system.exception.custom.UserLoginException;
...
public class SysUserController {
	...
	@ResponseBody
	public Object updateSysUser(HttpServletRequest request, HttpServletResponse response,SysUser sysUser ) throws Exception {
		request.setAttribute("fId", "fId:"+sysUser.getfId());//关键数据
	...
	@ResponseBody
	public Object getCurrentUser() throws UserLoginException {
		Map<String, Object> map=new HashMap<String, Object>();
		SysUser sysUser=(SysUser)PubUtil.getUser();
